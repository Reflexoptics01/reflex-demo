...
export default function Pricelist() {
  ...
  async function delete_doc(id) {
    await deleteDoc(doc(data, "pricelist", id));
    const collref = collection(data, "pricelist");
    ...
    const coll2 = collection(data, "log");
          ...
          await setDoc(doc(data, "log", ids), {
            change: "Deleted Pricelist : " + "ID:" + id,
            user: use,
            timestamp: Date.now()
          });
  }

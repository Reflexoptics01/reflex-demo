...
export default function Youtube() {
  ...
  async function delete_doc(id) {
    await deleteDoc(doc(data, "youtube", id));
    const collref = collection(data, "youtube");
    ...
    const coll2 = collection(data, "log");
          ...
          await setDoc(doc(data, "log", ids), {
            change: "Deleted Youtube link : " + "ID:" + id,
            user: use,
            timestamp: Date.now()
          });
  }
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="text-sm text-gray-900 max-w-3xl font-light px-6 py-4 ">
                              <p className="overflow-auto text-justify max-w-3xl">
                                {reflex.details}
                              </p>
                            </td>
                            <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
